  ...
  <div>
    <main class="w-2/3 flex flex-col h-screen">
      ...
      <div class="bg-gray-400">
        ...
        >
          ...
          <button
            class="bg-blue-500 hover:bg-blue-600 text-white inline-block p-2 float-right my-2"
            @click="sync()"
          >
            Sync classes
          </button>
    ...
    <aside class="overflow-auto absolute top-0 right-0 bottom-0 w-1/3 flex text-xs">
      <div class="flex-1 bg-gray-700 overflow-auto p-2 text-white">
        <select
          v-model="storeState.selectedPlaceholder"
          class="w-full mb-2 text-black border-2 border-orange-500"
        >
          <option
            v-for="placeholder in storeState.placeholders"
      ...
      <ul class="flex-1 bg-gray-500 overflow-auto p-2 text-white">
        <li
          v-for="subCategory in selectedMainCategory.subCategories"
      ...
      <section class="flex-1 bg-gray-400 overflow-auto">
        ...
        >
          <selection-panel
            v-if="subCategory === selectedSubCategory"
